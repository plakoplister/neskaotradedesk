    ...
    <Card>
      ...
      <CardContent className="prose max-w-none">
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg mb-6">
          <h3 className="text-xl font-semibold mb-4 text-amber-900">Une Innovation Entrepreneuriale Unique</h3>
          <p className="text-gray-700 mb-4">
            Fondée en septembre 2013, Neskao est <strong>la première entreprise africaine</strong> à transformer 
            les fèves de cacao hors normes en produits semi-finis de qualité. Cette société familiale dirigée par 
            Michel André Tournaire a développé un modèle d'affaires révolutionnaire qui valorise les déchets de la 
            filière cacao tout en créant de la valeur économique et sociale.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
            <div className="bg-white p-3 rounded-lg text-center shadow-sm">
              <p className="text-3xl font-bold text-amber-600">2013</p>
            ...
            <div className="bg-white p-3 rounded-lg text-center shadow-sm">
              <p className="text-3xl font-bold text-amber-600">32K</p>
              <p className="text-sm font-semibold">Tonnes/an</p>
              <p className="text-xs text-gray-600">Capacité totale</p>
            </div>
            <div className="bg-white p-3 rounded-lg text-center shadow-sm">
              <p className="text-3xl font-bold text-amber-600">FSSC</p>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold text-blue-900 mb-2">Capacités de Production Actuelles</h4>
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            <h4 className="font-semibold text-lg mb-4 text-blue-900">Marché du Cacao 2025-2026</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600">Production CI estimée</p>
                <p className="text-2xl font-bold text-blue-700">1.5M</p>
                <p className="text-xs text-gray-500">tonnes/an</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600">Prix moyen CAZ25</p>
                <p className="text-2xl font-bold text-blue-700">6,200</p>
                <p className="text-xs text-gray-500">GBP/tonne</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600">Récolte principale</p>
                <p className="text-2xl font-bold text-blue-700">900K</p>
                <p className="text-xs text-gray-500">tonnes (Oct-Déc)</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <p className="text-sm text-gray-600">Récolte intermédiaire</p>
                <p className="text-2xl font-bold text-blue-700">600K</p>
                <p className="text-xs text-gray-500">tonnes (Jan-Mar)</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    pour de nouveaux entrants africains bien positionnés.
                  </p>
                </div>
              </div>
            </div>
      ...
      <CardContent>
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h5 className="font-semibold text-green-800 mb-3">Forces de Neskao</h5>
            ...
            <div>
              <h5 className="font-semibold text-green-800 mb-3">Opportunités de Marché</h5>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-green-600">→</span>
          ...
          <div className="mt-6 p-4 bg-white rounded-lg">
            <p className="text-center font-semibold text-green-800">
              L'objectif : Évoluer d'une production actuelle de 32 000 tonnes/an vers un 
              <span className="text-2xl font-bold text-green-600 mx-2">227M€</span>
              de trading international en 3 ans
            </p>
          </div>
        </div>
      </CardContent>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <h5 className="font-semibold text-green-700 mb-3">🌍 Analyses Qualitatives</h5>
                <ul className="space-y-2 text-sm">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-lg">
            ...
            <p className="text-lg mb-2">
              L'analyse approfondie de 11 localisations potentielles révèle que <strong>Paris</strong> offre 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
              ...
              <div className="bg-white/20 p-3 rounded text-center">
                <p className="font-bold text-xl">171%</p>
