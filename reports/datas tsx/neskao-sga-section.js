const renderSGA = () => {
  ...
  // Données complètes des 13 localités (incluant Chypre)
  const villesData = [
    { nom: "Maroc CFC", an1: 687.870, an2: 716.538, an3: 971.143, total: 2375.551, rank: 1, fiscalite: "0%", zone: "Zone franche" },
    { nom: "Maurice", an1: 795.190, an2: 820.828, an3: 1086.163, total: 2702.181, rank: 2, fiscalite: "3%", zone: "Offshore" },
    { nom: "Andorre", an1: 873.970, an2: 858.218, an3: 1142.003, total: 2874.191, rank: 3, fiscalite: "10%", zone: "Zone franche" },
    { nom: "Paris", an1: 1290.093, an2: 1218.340, an3: 1478.138, total: 3986.571, rank: 4, fiscalite: "25%", zone: "Europe" },
    { nom: "Hambourg", an1: 1296.200, an2: 1252.598, an3: 1637.593, total: 4186.391, rank: 5, fiscalite: "30%", zone: "Europe" },
    { nom: "Chypre", an1: 1384.000, an2: 1330.000, an3: 1678.000, total: 4392.000, rank: 6, fiscalite: "12.5%", zone: "Europe" },
    { nom: "Amsterdam", an1: 1338.200, an2: 1318.168, an3: 1697.253, total: 4353.621, rank: 7, fiscalite: "25.8%", zone: "Europe" },
    { nom: "Dubai", an1: 1407.720, an2: 1330.658, an3: 1713.413, total: 4451.791, rank: 8, fiscalite: "0%", zone: "Zone franche" },
    { nom: "Tel Aviv", an1: 1451.390, an2: 1382.478, an3: 1816.743, total: 4650.611, rank: 9, fiscalite: "23%", zone: "Moyen-Orient" },
    { nom: "Genève", an1: 1693.000, an2: 1567.478, an3: 2002.513, total: 5262.991, rank: 10, fiscalite: "15%", zone: "Europe" },
    { nom: "Singapour", an1: 1754.470, an2: 1675.618, an3: 2142.973, total: 5573.061, rank: 11, fiscalite: "17%", zone: "Asie" },
    { nom: "Londres", an1: 1860.220, an2: 1736.338, an3: 2217.333, total: 5813.891, rank: 12, fiscalite: "25%", zone: "Europe" },
    { nom: "Genève LCM", an1: 1859.250, an2: 1715.618, an3: 2198.573, total: 5773.441, rank: 13, fiscalite: "15%", zone: "Europe" }
  ];
        ...
        <CardContent>
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-2xl font-bold text-blue-700">{bureauxData.evolution.an1}</p>
                <p className="text-sm text-gray-600">An 1</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-blue-700">{bureauxData.evolution.an2}</p>
                <p className="text-sm text-gray-600">An 2</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-blue-700">{bureauxData.evolution.an3}</p>
    ...
    <div className="space-y-6">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-2 text-center">Fiscalité</th>
                </tr>
              </thead>
              <tbody>
                {villesData.map((ville, idx) => {
                  const score = ville.rank <= 3 ? 'A' : ville.rank <= 7 ? 'B' : 'C';
                  const scoreColor = score === 'A' ? 'bg-green-100 text-green-800' : 
                                    score === 'B' ? 'bg-blue-100 text-blue-800' : 
                  ...
                  return (
                    <tr key={idx} className={idx % 2 === 0 ? 'bg-gray-50' : ''}>
                      ...
                      <td className="p-2 text-center">{ville.fiscalite}</td>
                    </tr>
                  );
                })}
              </tbody>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-green-50">
          <CardHeader>
            <CardTitle className="text-green-800">Score A - Optimal</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-sm">
        ...
        <Card className="bg-blue-50">
          <CardHeader>
            <CardTitle className="text-blue-800">Score B - Compétitif</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-sm">
        ...
        <Card className="bg-red-50">
          <CardHeader>
            <CardTitle className="text-red-800">Score C - Premium</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-sm">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-100 rounded-lg">
              ...
              <ul className="mt-2 space-y-1 text-sm">
                <li>✓ Meilleur score B en Europe (24% moins cher que Genève)</li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-green-50 to-green-100">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm text-green-800">Coût minimum</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold text-green-900">2,376k€</p>
            <p className="text-sm text-green-700">Maroc CFC (3 ans)</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-blue-50 to-blue-100">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm text-blue-800">Recommandé</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold text-blue-900">3,987k€</p>
            <p className="text-sm text-blue-700">Paris (3 ans)</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-purple-50 to-purple-100">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm text-purple-800">Écart coûts</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold text-purple-900">2.45x</p>
            <p className="text-sm text-purple-700">Entre min et max</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-orange-50 to-orange-100">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm text-orange-800">Effectifs An3</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold text-orange-900">5.5 FTE</p>
            <p className="text-sm text-orange-700">Toutes localisations</p>
          </CardContent>
        </Card>
      </div>
