...
const AnalyseDecisionnelle: React.FC = () => {
  ...
  const villesData: LocationData[] = [
    {
      ...
      ebitdaAn1: 0.02, equityAn1: 1.61, sgaTonne: 61, resultatsCumules: 6.88,
      scoreReglementation: 8.0, scoreImpactSocial: 6.1, scoreROI: 10.0, scoreDFI: 8.0, scoreCashFlow: 9.1,
      scoreFinal: 7.49, statut: 'EXCELLENT', decision: 'RECOMMANDÉ',
    ...
    },
    {
      ...
      ebitdaAn1: 0.40, equityAn1: 3.13, sgaTonne: 75, resultatsCumules: 5.92,
      scoreReglementation: 8.0, scoreImpactSocial: 6.3, scoreROI: 9.2, scoreDFI: 9.0, scoreCashFlow: 6.8,
      scoreFinal: 7.14, statut: 'EXCELLENT', decision: 'RECOMMANDÉ',
  ...
  const getColorByStatus = (statut: string) => {
    switch(statut) {
      case 'EXCELLENT': return 'bg-teal-50/30 text-teal-800';
      case 'BON': return 'bg-sky-50/30 text-sky-800';
      case 'MOYEN': return 'bg-gray-100 text-gray-800';
      case 'FAIBLE': return 'bg-rose-50/30 text-rose-800';
          ...
          <div className="overflow-x-auto pb-4">
            <div className="flex space-x-4 min-w-max">
              {villesAvecScoresRecalcules.map((ville, index) => {
                const colors = {
                  'EXCELLENT': 'from-teal-50/30 to-teal-100/30 border-teal-200',
                  'BON': 'from-sky-50/30 to-sky-100/30 border-sky-200',
                  'MOYEN': 'from-gray-100 to-gray-200 border-gray-300',
                  'FAIBLE': 'from-rose-50/30 to-rose-100/30 border-rose-200'
                };
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                de trading international de Neskao. Avec un score consolidé de <strong>8.09/10</strong>, Paris 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-sky-50/30 p-5 rounded-lg border-l-4 border-blue-500">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  ...
                  une exposition raisonnable. Les volumes évoluent de 12K tonnes (An1) à 36K tonnes (An3), 
                  générant des marges trading progressives de 2% à 5%.
                </p>
                <div className="bg-white p-2 rounded text-xs">
                  <strong>CA cumulé 3 ans:</strong> 611M€ • <strong>Marge moyenne:</strong> 3.2%
                </div>
              </div>
              ...
              <div className="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  L'équipe parisienne optimale comprend 6 personnes (An1) évoluant vers 9 (An3): 
                  Trading Manager, Risk Manager, Settlement, Back-office, Commercial, Compliance. 
                  Coûts SG&A maîtrisés à 60€/tonne (An3).
                </p>
                <div className="bg-white p-2 rounded text-xs">
                  <strong>Équipe An3:</strong> 9 personnes • <strong>SG&A/tonne:</strong> 60€
                </div>
              </div>
              ...
              <div className="bg-orange-50 p-5 rounded-lg border-l-4 border-orange-500">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  Rentabilité opérationnelle dès l'An 1 avec un EBITDA de 0.52M€. ROI 3 ans de 171.6% 
                  et payback de 2.3 ans. Résultats nets cumulés de 5.14M€ sur 3 ans, confirmant 
                  la viabilité économique du projet.
                </p>
                <div className="bg-white p-2 rounded text-xs">
                  <strong>EBITDA An1:</strong> +0.52M€ • <strong>ROI 3 ans:</strong> 171.6%
                </div>
              </div>
              ...
              <div className="bg-gray-100 p-5 rounded-lg border-l-4 border-yellow-500">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  Besoins en equity modérés (1.89M€ An1) avec accès privilégié à l'AFD/Proparco. 
                  Structure de financement 90% dette / 10% equity pour les activités forward. 
                  Coût total du financement optimisé à 0.85M€ (An1).
                </p>
                <div className="bg-white p-2 rounded text-xs">
                  <strong>Equity requis:</strong> 1.89M€ • <strong>Score DFI:</strong> 10/10
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-lg border-2 border-green-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white p-4 rounded-lg text-center">
                  <p className="text-3xl font-bold text-teal-600">8.09</p>
                  <p className="text-sm text-gray-600">Score Final /10</p>
                </div>
                <div className="bg-white p-4 rounded-lg text-center">
                  <p className="text-3xl font-bold text-sky-600">5.14</p>
                  <p className="text-sm text-gray-600">M€ Résultats 3 ans</p>
                </div>
                <div className="bg-white p-4 rounded-lg text-center">
                  <p className="text-3xl font-bold text-gray-600">171.6</p>
              ...
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <ul className="space-y-1">
                    <li>✅ EBITDA positif dès l'An 1 (+0.52M€)</li>
                    <li>✅ Besoins en capital modérés (1.89M€)</li>
