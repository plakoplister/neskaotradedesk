...
const Rentabilite: React.FC = () => {
  ...
  const ebitdaData = [
    { ville: 'Paris', an1: 0.52, an2: 2.84, an3: 9.93, roi3ans: 171.6, totalResNet: 5.14, cashReqis: 1.89 },
    { ville: 'Genève', an1: -0.09, an2: 2.75, an3: 9.62, roi3ans: 200.5, totalResNet: 5.66, cashReqis: 1.78 },
    { ville: 'Amsterdam', an1: 0.07, an2: 2.56, an3: 9.40, roi3ans: 176.8, totalResNet: 4.82, cashReqis: 1.74 },
    { ville: 'Londres', an1: -0.67, an2: 1.86, an3: 8.47, roi3ans: 98.8, totalResNet: 3.98, cashReqis: 2.00 },
    { ville: 'Hambourg', an1: 0.09, an2: 2.57, an3: 9.38, roi3ans: 127.9, totalResNet: 4.21, cashReqis: 1.85 },
    { ville: 'Andorre', an1: 0.76, an2: 3.25, an3: 10.25, roi3ans: 87.2, totalResNet: 5.39, cashReqis: 2.88 },
    { ville: 'Chypre', an1: 0.40, an2: 2.91, an3: 9.60, roi3ans: 165.0, totalResNet: 5.92, cashReqis: 2.38 },
    { ville: 'Maurice', an1: 0.82, an2: 3.29, an3: 10.29, roi3ans: 21.5, totalResNet: 4.57, cashReqis: 3.76 },
    { ville: 'Maroc CFC', an1: 0.93, an2: 3.40, an3: 10.43, roi3ans: -15.9, totalResNet: 4.77, cashReqis: 5.67 },
    { ville: 'Dubai', an1: 0.00, an2: 2.52, an3: 9.31, roi3ans: 112.0, totalResNet: 5.49, cashReqis: 2.59 },
    { ville: 'Tel Aviv', an1: -0.06, an2: 2.44, an3: 9.16, roi3ans: 71.6, totalResNet: 3.73, cashReqis: 2.17 },
    { ville: 'Singapour', an1: 0.02, an2: 2.58, an3: 9.40, roi3ans: 327.5, totalResNet: 6.88, cashReqis: 1.61 }
  ];
  ...
  const plDetailData = [
    ...
    },
    {
      ...
      gainsFutures: { an1: 0.71, an2: 1.63, an3: 7.14 },
      totalRevenus: { an1: 1.78, an2: 4.25, an3: 11.55 },
      totalCharges: { an1: 1.63, an2: 1.50, an3: 1.93 },
      ebitda: { an1: -0.09, an2: 2.75, an3: 9.62 },
      resultatNet: { an1: -0.82, an2: 1.07, an3: 5.96 },
      fiscalite: '15.15%'
    },
    {
      ville: 'Amsterdam',
    ...
    },
    {
      ...
      ca: { an1: 54.16, an2: 132.57, an3: 227.58 },
      margeTrading: { an1: 1.07, an2: 2.62, an3: 4.41 },
      gainsFutures: { an1: 0.71, an2: 1.63, an3: 6.90 },
      totalRevenus: { an1: 1.78, an2: 4.25, an3: 11.31 },
      totalCharges: { an1: 1.38, an2: 1.34, an3: 1.71 },
      ebitda: { an1: 0.40, an2: 2.91, an3: 9.60 },
      resultatNet: { an1: -0.51, an2: 0.84, an3: 5.59 },
      fiscalite: '10%'
    },
    {
      ville: 'Maurice',
  ...
  const classementFinal = [
    { ville: 'Singapour', rang: 1, ebitdaAn1: 0.02, resultatNet3ans: 6.88, roi3ans: 327.5, pointForts: 'GTP 5-10%' },
    { ville: 'Dubai', rang: 2, ebitdaAn1: 0.00, resultatNet3ans: 5.49, roi3ans: 112.0, pointForts: 'Zone franche' },
    { ville: 'Andorre', rang: 3, ebitdaAn1: 0.76, resultatNet3ans: 5.39, roi3ans: 87.2, pointForts: 'Fiscalité 10%' },
    { ville: 'Paris', rang: 4, ebitdaAn1: 0.52, resultatNet3ans: 5.14, roi3ans: 171.6, pointForts: 'Liens CI' },
    { ville: 'Genève', rang: 5, ebitdaAn1: -0.09, resultatNet3ans: 5.66, roi3ans: 200.5, pointForts: 'Finance hub' },
    { ville: 'Amsterdam', rang: 6, ebitdaAn1: 0.07, resultatNet3ans: 4.82, roi3ans: 176.8, pointForts: 'Port #1' },
    { ville: 'Maroc CFC', rang: 7, ebitdaAn1: 0.93, resultatNet3ans: 4.77, roi3ans: -15.9, pointForts: 'CFC 8,75%' },
    { ville: 'Maurice', rang: 8, ebitdaAn1: 0.82, resultatNet3ans: 4.57, roi3ans: 21.5, pointForts: 'Hub africain' },
    { ville: 'Hambourg', rang: 9, ebitdaAn1: 0.09, resultatNet3ans: 4.21, roi3ans: 127.9, pointForts: 'Port #2' },
    { ville: 'Londres', rang: 10, ebitdaAn1: -0.67, resultatNet3ans: 3.98, roi3ans: 98.8, pointForts: 'Coûts élevés' },
    { ville: 'Tel Aviv', rang: 11, ebitdaAn1: -0.06, resultatNet3ans: 3.73, roi3ans: 71.6, pointForts: 'Tech hub' },
    { ville: 'Chypre', rang: 12, ebitdaAn1: 0.40, resultatNet3ans: 5.92, roi3ans: 165.0, pointForts: 'UE member' }
  ];
